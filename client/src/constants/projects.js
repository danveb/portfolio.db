...
export const projects = [
    ...
    }, 
    {
        ...
        img: ioniq5, 
        title: "ioniq5 Lookup", 
        description: "App designed for users who want to search deliveries of 2022 Hyundai IONIQ 5 to local dealerships. User fills in the zipcode and desired radius (in miles). Data is fetched from Hyundai USA's API and key info is displayed on a table.", 
        buttons: ["React", "Sass", "Express", "Hyundai USA API", "Surge"], 
        backgroundColor: "var(--ny-pink)", 
        liveSite: "https://ioniq5-lookup.surge.sh/", 
        githubRepo: "https://github.com/danveb/ioniq5-lookup", 
        target: "_blank", 
        rel: "noreferrer noopener", 
    }, 
    {
